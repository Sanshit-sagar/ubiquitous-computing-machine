  ...
  return (
    <div className="w-full max-w-screen-lg mx-auto">
        ...
        <textarea
            ...
            placeholder="Title…"
            disabled={disabled}
            className="w-full text-3xl font-bold leading-snug bg-transparent outline-transparent appearance-none resize-none disabled:cursor-not-allowed"
        />
      ...
      <div className="mt-6 flex justify-center sm:justify-between items-center space-x-2 px-4 py-2 rounded bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-100 sticky top-0">
        <div className="flex flex-row justify-flex-end items-center space-x-6 sm:space-x-4">
