...
const aggregateStats = (clickstream) => {
    ...
    clickstream.forEach(click => {
        ...
        const destination = click.visitor ? click.visitor.host : click.user ? click.user.host : ''
...
const TimeseriesList = () => {
    ...
    return (
        <div className="container mx-auto mt-2">
            <CustomSortedTable sortedData={topDestinations} title="Destination URLs" />
            ...
            <div className="container h-full w-full m-2 p-2 shadow-lg">
                <PieChart sortedData={topDestinations} title="Top Destination URLs"/> 
            </div>
        </div>
    );
}
