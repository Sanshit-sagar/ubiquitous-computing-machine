...
const buttonClass = 'bg-white text-gray-700 hover:bg-blue-300 hover:text-gray-900 py-1 px-3 m-2 rounded-md shadow-md'
    ...
    return (
        <div className="w-auto">
            <TableContainer className="bg-gray-700">
                <div className="inline-flex justify-end align-stretch mb-3 m-2 p-2">
