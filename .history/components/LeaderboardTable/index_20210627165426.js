...
const LeaderboardTableItem = ({ data }) => {
    if(!data) return null
...
// let leaderboards = [
//     { id: 'topUserAgents', title: 'User Agents'  },
//     { id: 'topHttpProtocols', title: 'HTTP Protocols'}, 
//     { id: 'topTlsVersions', data: title: 'TLS Versions'},
//     { id: 'topIps', title: 'IP Addresses' },
//     { id: 'topHosts',  title: 'Hosts' }, 
// ]
...
const LeaderboardTable = ({ email, time }) => {
    ...
    return (
        <div key={barCharts['topIps']} className="flex justify-start align-stretch m-1 p-2 rounded-md shadow">
            <LeaderboardTableItems data={data} />
        </div>
    )
}
