                ...
                return (
                    <div key={index}>
                        <ActionButtonItem
                            ...
                            // onClick={() => {
                            //     let canMove = isMovePossible(index);
                            //     if(canMove) {
                            //         execTransition(option.value)
                            //     }
                            // }}
                        >
                            {option.icon} 
...
const Toolbar = ({
    ...
    return (
        <div className={uiState.darkMode ? darkTheme : lightTheme}>
            <Box css={{ py: '$2', px: '$3', height: '50px', bc: '$loContrast', color: '$hiContrast', borderBottom: `thin sold ${'$hiContrast'}` }}>
