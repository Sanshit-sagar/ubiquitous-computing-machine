...
const reactionIcons = [
    { id: 'trash', icon: LetterCame, feeling: 'This app and crumpled paper, both belong in da trash', color: 'red' },
    { id: 'mixedFeelings', icon: LetterCae, icon: Half2Icon, feeling: 'It reminded me of badly done feng shui', color: 'black' },
    ...
    return (
        <Popover>
            <PopoverTrigger as={IconButton}>
                <span style={{ width: '85px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start'}}>
