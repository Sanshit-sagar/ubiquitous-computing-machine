...
import { violet, blackA, gainsboro, mauve } from '@radix-ui/colors'
        ...
        <Box css={{ backgroundColor: '$loContrast' }}>
            <Flex css={{ flexDirection: 'column', justifyContent: 'space-around', alignItems: 'stretch', gap: 10 }}>
                ...
                <Box css={{ width: '100%', backgroundColor: 'white', padding: '$1' }}>
                    <Flex css={{ flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box css={{ marginRight: '5px', borderRadius: '5px' }}>
