...
const StyledInput = ({ searchQuery, searchArea }) => {
    ...
    return (
        <ToggleButton
            ...
            unpressedElem={
                <Box css={{ width: '200px', flexBasis: '1' }}>
                    <Flex css={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', gap: '4px', width: '150px' }}>
                        <MagnifyingGlassIconSvg />
                        <Text css={{ marginLeft: '5px' }}> Looking for something? </Text>
                    </Flex>
                </Box>
            }
        />  
