                                        ...
                                        content={
                                              ...
                                              <div>
                                                { state.searchbar.results.map(function(click, index) { 
                                                    ...
                                                    return (
                                                        <div style={{ width: '100%', height: '40px', marginTop: '1px', marginBottom: '1px', padding: '3px', borderRadius: '5px', padding: '1px 3px 0px 2px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start'}}>
