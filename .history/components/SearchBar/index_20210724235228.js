...
const StyledInput = ({ searchQuery, searchArea }) => {
    ...
    return (
        <ToggleButton
            ...
            unpressedElem={
                <Flex css={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: '4px', width: '150px' }}>
                                ...
                                <div style={{ marginTop: '5px', width: '100%' }}>
                                    <ScrollView 
                                        content={
                                              ...
                                              ? searchQuery.length ? <NoSearchResults />  
                                              : <NoSearchResults /> : 
                                              <div>
                                                { state.searchbar.results.map(function(click, index) { 
                                                    let clickPercentage = click.score * 100
                                                    return (
                                                        <div style={{ width: '95%', height: '40px', marginTop: '1px', marginBottom: '1px', padding: '3px', borderRadius: '5px', padding: '1px 3px 0px 2px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start'}}>
