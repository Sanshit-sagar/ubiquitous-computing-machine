...
const useUserClickstream = (isPopoverOpen, email) => {
    const { data, error } =  useSWR(isPopoverOpen && email && email.length ? `/api/slugs/aliases/${email}` : null)
...
const SearchBar = (props) => {
    ...
    const { clickstream, isLoading, isError } = useUserClickstream(isPopoverOpen, email);
