...
const useUserClickstream = ({ doFetch, email }) => {
    ...
    return {
        ...
        isError: error,
        isWaiting: !data && !isLoading && (email || !email?.length),
    };
}
...
const SearchBar = (props) => {
    ...
    const { clickstream, isLoading, isError } = useUserClickstream({ doFetch, email });
    ...
    }, [clickstream, isLoading, isError, searchArea, doFetch]);
