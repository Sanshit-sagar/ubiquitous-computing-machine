...
const FlyoutMenu = ({
  ...
  return (
    <div className="absolute top-10 right-0 z-50 w-80 hidden sm:block">
      <div className="rounded-lg shadow-lg ring-1 ring-gray-900 dark:ring-gray-700 ring-opacity-5 bg-red-500 text-gray-900 dark:bg-green-500 dark:text-gray-100 divide-y divide-gray-200 dark:divide-gray-700">
