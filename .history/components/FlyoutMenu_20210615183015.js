      ...
      <div className="rounded-lg shadow-lg ring-1 ring-gray-900 dark:ring-gray-700 ring-opacity-5 bg-gray-900 text-gray-50 dark:bg-gray-50 dark:text-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="px-5 py-3">
          <button
            type="button"
            onClick={signOut}
            className="-mx-2 -my-1 px-2 py-1 flex justify-center items-center space-x-2 opacity-70 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-blue-600 rounded text-red-500"
          >
