        ...
        <InputElementCardWrapper
            ...
            children={
                ...
                <input 
                    ...
                    id="ttl" 
                    value={state.ttl}
                    onChange={(event) => {mutate('ttl', event.target.value)}}
                    type="datetime-local"
        ...
        <InputElementCardWrapper
            ...
            children={
                <Radio.Group
                    ...
                    value={state.routerStatus}
                    onChange={(event) => {mutate('routerStatus', event.target.value)}}
                >
                    <>
                        <Radio
                            label="HTTP 301"
        ...
        return (
            <div className="w-full inline-flex justify-between align-end">
                ...
                <div className="w-full inline-flex justify-end align-end">
                    <Button 
                        type={!session || !session?.user ? "dashed" : "primary"}
                        size="small"
                        icon={<XCircleIcon className="h-6 w-6 text-green" />}
                        loading={cancelLoading || sessionLoading || submitLoading}
                    ...
                    <Button 
                        type={!session || !session?.user ? "default" : "primary"}
                        size="small"
