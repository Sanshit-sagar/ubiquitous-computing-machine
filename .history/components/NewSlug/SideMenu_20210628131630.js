...
function NewSlugNavMenu() {
    const items = [
        ...
        { id: 'ttle', title: 'Expiration (TTL)', icon: '', color },
        { id: 'descriptions', title: 'Descriptions', icon: '', color },
        { id: 'destination', title: 'Destination', icon: '', color },
        { id: 'destination', title: 'Destination', icon: '', color },
    ]
    return (
      <Menu>
        {/* <Menu.Group title="Basic Details" /> */}
