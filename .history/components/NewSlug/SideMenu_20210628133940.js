...
function NewSlugNavMenu() {
    const items = [
        ...
        { id: 'ipBlacklists', title: 'blacklists', icon: <BanIcon className="h-6 w-6"/> },
        { id: 'redirects', title: 'Redirect Rules', icon: <ExternalLinkIcon className="h-6 w-6" /> },
        { id: 'seo', title: 'seo', icon: <LightningBoltIcon className="h-6 w-6"/> },
        { id: 'discard', title: 'discard', icon: <TrashIcon stroke="red" className="h-6 w-6" /> },
    ]
