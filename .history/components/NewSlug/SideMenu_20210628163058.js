...
function NewSlugNavMenu() {
    const items = [
        ...
        { id: 'ttl', title: 'Expiration (TTL)', icon: <CalendarIcon className="h-6 w-6" className="pink" /> },
        { id: 'password', title: 'Expiry', icon: <LockClosedIcon className="h-6 w-6" className="black" /> },
        { id: 'ipBlacklists', title: 'IP Blacklists', icon: <BanIcon className="h-6 w-6" stroke="black-and-white/> },
        { id: 'redirects', title: 'Routing Rules', icon: <ExternalLinkIcon stroke="blue" className="h-6 w-6" /> },
        { id: 'seo', title: 'SEO Parameters', icon: <LightningBoltIcon stroke="yellow" className="h-6 w-6"/> },
