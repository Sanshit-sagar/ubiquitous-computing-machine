...
function NewSlugNavMenu() {
    const items = [
        ...
        { id: 'ttl', title: 'Expiry (TTL)', icon: <CalendarIcon className="h-6 w-6" stroke="pink" /> },
        { id: 'password', title: 'Encryption', icon: <LockClosedIcon className="h-6 w-6" stroke="black" /> },
