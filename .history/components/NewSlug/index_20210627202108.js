...
function NewSlugHeader() {
    return (
      <div className="bg-white px-2 py-4 border-b border-gray-200 sm:px-3">
...
const UrlSlug = () => {
    ...
    return (
        <div className="mt-6 mb-6">
            <label htmlFor="first_name" className="block text-sm font-extralight text-gray-700">
                Slug
            </label>
            <div className="mt-1">
                {
...
const UrlInput = () => {
    ...
    return (
        <div  className="col-span-3 sm:col-span-3">
            <label htmlFor="company_website" className="block text-sm font-extralight text-black ">
                Destination URL
            </label>
    ...
    return (
        <div>
            <div className="flex justify-between">
                <label htmlFor="email" className="block text-sm font-extralight text-black">
                    Expiration (TTL)
                </label>
                <span className="text-sm font-extralight text-black " id="email-optional">
                    Optional
                </span>
            </div>
...
const BasicDetailsForm = () => {
    ...
    return (
    <div className="container mx-auto m-2 bg-white">
