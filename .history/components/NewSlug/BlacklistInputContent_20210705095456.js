...
const BlacklistedIpList = ({ blacklist, handleBlacklistDeletion }) => {
    ...
    return (
        ...
        >
            <Card>
                {!blacklist.length 
                    ?   <Typography.Text> Add IP addresses below to start seeing your blacklist here </Typography.Text> 
                    :  <> <Typography.Title level={4}> Blacklisted IP Addresses </Typography.Title> <br /> </>
                }
