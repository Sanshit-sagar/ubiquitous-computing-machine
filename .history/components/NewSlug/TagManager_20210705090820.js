  ...
  return (
    <>
      ...
      <Select
        ...
        icon={<IconActivity />}
      >
        {Object.entries(categoryKeyMap)[index][1].map(function(value, keyIndex) {
          return (
            <Select.Option 
              key={index}
              value={Object.entries(categoryKeyMap)[index][1][keyIndex]}
            > 
              {Object.entries(categoryKeyMap)[index][1][keyIndex]}
            </Select.Option> 
          ); 
        })}
      </Select>
