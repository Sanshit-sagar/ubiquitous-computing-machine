...
// import { Menu } from "@supabase/ui";import { CalendarIcon, LinkIcon, BanIcon, ExternalLinkIcon, TrashIcon, LightningBoltIcon, CursorClick } from '@heroicons/react/outline';
...
function NewSlugNavMenu() {
    ...
    const items = [
        { id: 'destination', title: 'Destination URL', icon: <LinkIcon className="h-6 w-6" /> },
    ...
    return (
            <> 
                <p className="text-black text-md font-extralight"> {state.currentTab} </p>
                <Menu 
