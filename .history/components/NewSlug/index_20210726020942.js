...
const NewSlug = () => {
    ...
    return (
        <Card style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', margin: '0px 15px 0px 2px' }}> 
            <div> 
                <CustomToolbar />
                <VerticalTabsWrapper 
            ...
            <div style={{ width: '100%', padding: '5px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'stretch' }}>
                <Button
                    ...
                    intent="success"
                    text={<span className="text-md font-extralight"> Save </span>}
                />
            </div>
        </Card>
    );
