...
function NewSlugActions() {
    ...
    const handleSubmit = () => {
        ...
        toast.message(`Saving url: ${url}, slug: ${slug}, ttl: ${ttl}, password: ${password}, routingStatus: ${routingStatus}`);
        toast.success(`blacklist: ${JSON.stringify(blacklist)}, seoTags: ${JSON.stringify(seoTags)}}`);
