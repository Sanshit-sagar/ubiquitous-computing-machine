...
const ExpirationInput = () => {
    ...
    return (
        ...
        <input 
            ...
            type='datetime-local'
            className="mt-2 mb-3 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-90 sm:text-sm border-gray-300 rounded-md dark:text-white dark:bg-gray-700"
