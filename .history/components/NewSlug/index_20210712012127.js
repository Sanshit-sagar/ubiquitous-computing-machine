...
import { DocumentDuplicateIcon, GlobeAltIcon, SpeakerphoneIcon, UserGroupIcon } from '@heroicons/react/solid';
...
function NewSlugNavMenu() {
    ...
    const analytics = [
        { id: 'seo', title: 'UTM Campaigns', icon: <UserGroupIcon className='h-6 w-6' />, tab: <TagManager />},
