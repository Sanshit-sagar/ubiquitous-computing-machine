...
function NewSlugNavMenu() {
    const items = [
        { id: 'basics', title: 'Basic Details', icon: '', color: '' },
        { id: 'ttl', title: 'Expiration (TTL)', icon: '', color },
        { id: 'password', title: 'Encryptions', icon: '', color },
        { id: 'ipBlacklists', title: 'blacklists', icon: '', color },
        { id: 'redirects', title: 'Redirect Rules', icon: '', color },
        { id: 'seo', title: 'seo', icon: '', color },
    ]
