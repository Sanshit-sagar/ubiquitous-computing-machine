...
import { Card, Typography, IconActivity, Input, Button } from '@supabase/ui'
...
function NewSlugCard() {
    ...
    const handleSubmit = () => {
        ...
        toast.success({ message: `Successfully saved your new slug: ${newSlugId}`})
    }
    ...
    <div className="container mx-auto m-2 rounded-m">
        ...
        >
            <div className="w-full inline-flex justify-between items-stretch">
                ...
                <Button
                    loading={sessionLoading || submitLoading} 
                    onClick={handleSubmit}
                >
                    <SaveIcon /> 
                </Button>
