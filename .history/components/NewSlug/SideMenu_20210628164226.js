...
function NewSlugNavMenu() {
    const items = [
        ...
        { id: 'redirects', title: 'Routing Rules', icon: <ExternalLinkIcon title={padding.href} icon={icon} className='h-6 w-6' />},
        { id: 'seo', title: 'SEO Parameters', icon: <LightningBoltIcon id={ame} className='h-6 w-6' />},
