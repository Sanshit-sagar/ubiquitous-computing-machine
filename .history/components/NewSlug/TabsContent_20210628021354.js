...
const ExpirationSelectorWrapper = () => {
...
function ExpirationSelector({ isOptional, title, instruction, outputMessage, isSuccessful }) {
    ...
    return (
        <div className="w-full flex-col justify-start align-start p-5 m-3 pr-10 border border-black rounded-md bg-white text-gray-700 font-extralight">
...
export default ExpirationSelectorWrapper 