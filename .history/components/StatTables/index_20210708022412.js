...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const { start, end, max, maxIndex, timeseries, freqs, average, userAgent, loading, tsError }  = useTimeseries(email)
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osNames', stat: Object.entries(sua.sortedOsNames), loading : suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat: Object.entries(sua.sortedOsNames), loading: suaLoading },
        { index: '6', title: 'Top Engines', variable: 'engines', stat: Object.entries(sua.sortedOsNames), loading: suaLoading },
    ];
