...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osNames', stat:  sua ? Object.entries(sua.sortedOsNames) : [], loading : suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat: sua ?  Object.entries(sua.sortedBrowsers): [], loading: suaLoading },
        { index: '6', title: 'Top Engines', variable: 'engines', stat: sua ? Object.entries(sua.sortedEngines): [], loading: suaLoading },
    ];
    ...
    return (
        <div className="w-72">
            <p>{Object.entries(userAgents).length} </p> 
            <Listbox 
