...
const StatTables = ({ email }) => {
    ...
    return (
        <Card>
            <div style={{ width: '100%', marginLeft: '20px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch', margin: '0px 0px 20px 0px', padding: '2.5px' }}>
                <div>
