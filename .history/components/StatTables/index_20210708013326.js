...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'Operating Systems', stat: !userAgents ? ['nah'] : sua.osNames, loading: loading || suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'Web Browsers', stat: !userAgents ? ['nah'] :  sua.browsers, loading: loading || suaLoading },
        { index: '6', title: 'Top Engines', variable: 'Engines', stat: !userAgents ? ['nah'] : sua.enginers, loading: loading || suaLoading },
    ];
