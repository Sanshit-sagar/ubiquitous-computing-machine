...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat:  Object.entries(sua.sortedBrowsers), loading: suaLoading },
        { index: '6', title: 'Top Engines', variable: 'engines', stat: Object.entries(sua.sortedEngines), loading: suaLoading },
    ];
