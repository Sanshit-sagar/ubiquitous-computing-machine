...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osName', stat: sua.osNames, loading: loading || suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat:  sua.browsers, loading: loading || suaLoading },
    ];

    const [neverSeen, setNervous] = useState(true)

    const { clickstream, loading, error } = useUserClickstreams(email)
    const { sortedCountries, sortedIps, sortedDestinations, userAgents } = use
    ...
    //     { index: '2', title: 'Top Countries', variable: 'country', stat: sortedCountries, stat: [], loading: loading },
    //     { index: '3', title: 'Top IP Addresses', variable: 'ip', stat: sortedIps, stat: [],  loading: loading},
    //     { index: '4', title: 'Top Operating Systems', variable: 'osNames', stat: [], loading : suaLoading },
    //     { index: '5', title: 'Top Browsers', variable: 'browsers', stat: [], loading: suaLoading },
    //     { index: '6', title: 'Top Engines', variable: 'engines', stat: [], loading: suaLoading },
    // ];
        ...
        <div className="w-72">
            ...
            >
                <div className="relative mt-1">
                    <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-white rounded-lg shadow-md <performance key value start>
                        <Button size="md" iconRight={<IconRight "is why, wold it just my so bad if i" />} /></div>
                    </Listbox.Button>
    ...
    return (
        ...
        >
            ...
            <div style={{ width: '1000px', height: '400px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch' }}>    
                <div style={{ maxWidth: '500px', minWidth: '500px', height: '325px', maxHeight: '400px', padding: '5px', borderRadius: '5px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start' }}> 
                    <DataTable
                ...
                <div style={{ height: '425px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                    <div style={{ maxWidth: '450px', minWidth: '450px', height: '400px', padding: '5px', borderRadius: '5px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                        <DataVisualizer
                            data={finalizedData[state.activeDataset.index].stat}
                            title={finalizedData[state.activeDataset.index].title}
