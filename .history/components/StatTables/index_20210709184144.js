...
const StatTables = ({ email }) => {
    ...
    return (
        <Card>
            <div style={{ width: '100%', marginHorizontal: '20px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch', margin: '0px 0px 20px 0px', padding: '2.5px' }}>
                <div>
            ...
            <div style={{ width: '1000px', display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'stretch' }}>    
                <div style={{ maxWidth: '450px', minWidth: '450px', maxHeight: '400px', overflowY: 'hidden', borderRadius: '5px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start' }}> 
                    <DataTable
