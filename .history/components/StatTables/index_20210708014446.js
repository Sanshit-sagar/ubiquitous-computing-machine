...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osNames', stat: [], loading : loading || suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers',stat: [], loading: loading || suaLoading },
        { index: '6', title: 'Top Engines', variable: 'engines', stat: [], loading: loading || suaLoading },
    ];
