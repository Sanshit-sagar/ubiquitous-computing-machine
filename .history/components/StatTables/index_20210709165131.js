...
const StatTables = ({ email }) => {
    ...
    return (
        <Card>
            {/* title={ */}
                <div style={{ width: '100%', margin: '0px 0px 20px 0px', display: 'flex', flexDirection: 'row', justifyContent: 'justify-start', alignItems: 'flex-start' }}>
        ...
        {/* > */}
            ...
            <div style={{ width: '1000px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch' }}>    
                <div style={{ maxWidth: '500px', minWidth: '500px', maxHeight: '400px', overflowY: 'hidden', padding: '5px', borderRadius: '5px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start' }}> 
                    <DataTable
