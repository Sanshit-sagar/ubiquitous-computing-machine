    ...
    return (
        ...
        >
            ...
            <div style={{ width: '1000px', height: '400px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch' }}>    
                <div style={{ maxWidth: '500px', minWidth: '500px', height: '325px', overflowY: 'scroll', maxHeight: '400px', padding: '5px', borderRadius: '5px' }}> 
                    <DataTable
                ...
                <div style={{ height: '425px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
