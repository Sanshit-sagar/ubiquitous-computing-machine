...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osNames', stat: sua.sortedOsNames, loading : suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat: sua.sortedBrowsers, loading: suaLoading },
        { index: '6', title: 'Top Engines', variable: 'engines', stat: sua.sortedEngines, loading: suaLoading },
    ];
