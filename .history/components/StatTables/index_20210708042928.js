...
const ActiveDatasetSelector = ({ email }) => {
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osNames', stat: Object.entries(sua.osNames), loading : suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat: Object.entries(sua.), loading: suaLoading },
