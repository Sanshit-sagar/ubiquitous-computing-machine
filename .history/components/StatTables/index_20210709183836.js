            ...
            >
                <div className="relative mt-1">
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0"
                    >
                        <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base bg-white dark:bg-gray-700 dark:text-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
...
const StatTables = ({ email }) => {
    ...
    return (
        <Card>
            <div style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch', margin: '0px 0px 20px 0px', padding: '2.5px' }}>
                <div>
