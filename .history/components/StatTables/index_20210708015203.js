...
const StatTables = ({ email }) => {
    ...
    sua && Object.entries(sua.sortedEngines),
    ...
    const finalizedData = [
        ...
        { index: '4', title: 'Top Operating Systems', variable: 'osName', stat: sua && Object.entries(sua.sortedOsNames), loading: loading || suaLoading },
        { index: '5', title: 'Top Browsers', variable: 'browsers', stat:  sua && Object.entries(sua.sortedBrowsers), loading: loading || suaLoading },
        { index: '6', title: 'Top Engines', variable: 'engines', stat: sua.engines, loading: suaLoading },
            loading: loading || suaLoading },
    ];
