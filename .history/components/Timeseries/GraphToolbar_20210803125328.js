...
import {BarChartIcon, SliderIcon, CalendarIcon} from '@radix-ui/react-icon'
  ...
  return (
      <Box css={{ width: '100%', py: '$1', px: '$2', height: '50px', bc: '#fff', color: '#000', border: 'thin solid white', br: '5px' }}>
          <Flex css={{ width: '100%', fd: 'row', jc: 'flex-end', ai: 'stretch' }}>
            ...
            <AccessibleStyledButton icon={<BarChartIcon />} content={<span className="text-small"> Frequency </span>} label={'Scatter Plot'} />
        
            <AccessibleStyledButton icon={<SliderIcon />} content={<span className="text-small"> Timeseries </span>} label={'Scatter Plot'} />
        
            <AccessibleStyledButton icon={<CalendarIcon />} content={<span className="text-small"> ScatterPlot </span>} label={'Scatter Plot'} />
