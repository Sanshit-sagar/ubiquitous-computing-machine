  ...
  return (
      <Box css={{ width: '100%', py: '$1', px: '$2', height: '50px', bc: '#fff', color: '#000', border: 'thin solid white', br: '5px' }}>
          <Flex css={{ width: '100%', fd: 'row', jc: 'flex-end', ai: 'stretch' }}>
            ...
            <AccessibleStyledButton icon={<SliderIcon />} content={'Timeseries'} label={'Scatter Plot'} />
        
            <AccessibleStyledButton icon={<CalendarIcon />} content={'Content'} label={'Scatter Plot'} />
