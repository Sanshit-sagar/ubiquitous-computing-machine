...
import { ScatterPlot, LineGraph, BarGraph } from './index'
      ...
      <Flex css={{ fd: 'row', jc: 'flex-end', ai: 'center' }}>
        ...
        >
          <Tab 
            ...
            panel={
              <BarChart barChartArr={state.barChartArr} barChartStr={state.barChartStr} data={state.barChartData} />
            } 
          />
          ...
          <Tab id="line" title={<Button text="Total Visits" icon="chart" minimal={true}/>} 
            panel={
              <LineChart 
                lineChartArr={state.lineChartArr} 
                lineChartStr={state.lineChartStr} 
          ...
          <Tab 
            ...
            panel={
              <ScatterPlot 
                scatterPlotArr={state.scatterPlotArr} 
                scatterPlotStr={state.scatterPlotStr} 
                data={state.scatterPlotArr} 
              />
            } 
          />
          <Tabs.Expander />
