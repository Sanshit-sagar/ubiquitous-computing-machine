...
export const SlugViews = ({ slug }) => {
    ...
    return (
        <SlugViewsContainer>
            <LabelledStatistic name={'Total Views'} value={views.total} />
            <LabelledStatistic name={'Unique Views'} value={views.unique} />
            <LabelledStatistic name={'Views Today'} value={views.daily} />
        </SlugViewsContainer>
    ); 
}
