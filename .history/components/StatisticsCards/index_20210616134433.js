...
const stats = {
    numClicks: { name: 'Clicks', value: '000', updatedAt: '', period: '' },
    numLinks: { name: 'Visits', value: '000', updatedAt: '', period: '' },
    mostViewed: { name: 'Most Viewed', value: '000', updatedAt: '', period: '' },
    movingAverages: { name: 'Moving Averages', value: '000', updatedAt: '', period: ''}
}
...
function StatisticsCards() {
    ...
    const stats = {
        numClicks: { name: 'Clicks', value: `${numViews}`, updatedAt: '', period: '' },
        numLinks: { name: 'Visits', value: `${numViews}`, updatedAt: '', period: '' },
        // mostViewed: { name: 'Most Viewed', value: '000', updatedAt: '', period: '' },
        // movingAverages: { name: 'Moving Averages', value: '000', updatedAt: '', period: ''}
    }
