...
const TableController = ({
    ...
    return (
        <div className={darkTheme}>
            <Box css={{ py: '$2', px: '$3', height: '50px', bc: darkTheme.colors.loContrast, color: darkTheme.colors.hiContrast, border: 'thin solid `${darkTheme.colors.hiContrast}`', br: '$1' }}>
