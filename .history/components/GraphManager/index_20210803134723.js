...
export const LineChart = () => {
    ...
    return (
        <Line
            data={generateData(state.cummFreqsArr, false, LINE_CHART_STR, state.datasetStart, state.datasetEnd)}
            options={{
...
export const ScatterPlot = () => {
    ...
    return (
        <Scatter
            data={generateData(state.scatterPlotArr, false, SCATTER_PLOT_STR, state.datasetStart, state.datasetEnd)}
            options={{
                maintainAspectRatio: false,
                plugins: {
                    tooltip: {
...
export const BarChart = () => {
    ...
    return (
        <Bar
            data={generateData(state.freqsArr, false, BAR_CHART_STR, state.datasetStart, state.datasetEnd)}
            width={1200}
            height={475}
            options={{
                maintainAspectRatio: false,
