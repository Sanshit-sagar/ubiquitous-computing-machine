...
const DarkMode = () => {
    ...
    const StyledSunIcon = () => <SunIcon className="h-6 w-6 text-blue-800 hover:focus-ring-2 hover:focus-ring-yellow-500" />;
    const StyledMoonIcon = () => <MoonIcon className="h-6 w-6 text-gray-50 hover:focus-ring-2 hover:focus-ring-yellow-500" />;
