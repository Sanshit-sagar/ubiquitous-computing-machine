...
export const NoSearchResults:React.FC<EmptyStateProps> = ({name, cause, icon, action}: EmptyStateProps) => {
    ...
    return (
        <div className="EmptyState">
            ...
            <div className="EmptyState__Actions">
                <button type="button" tabindex="0" class="PrimaryAction">Add new account</button>
                <button type="button" tabindex="0" class="SecondaryAction">Learn more</button>
            </div>
        </div>
