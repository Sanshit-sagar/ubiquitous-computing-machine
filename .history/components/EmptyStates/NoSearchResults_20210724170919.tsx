...
export const NoSearchResults:React.FC<EmptyStateProps> = (props) => {
        ...
        <div className="EmptyState">
            ...
            <div className="EmptyState__Content">
                ...
                <div className="Description">
                    Looks like you haven’t added any bank account yet. We advise using your own bank account to add money to your balance.
                </div>
            </div>

            <div className="EmptyState__Actions">
                <button type="button" tabIndex={parseInt("0")}  class="PrimaryAction">
                    Add new account
                </button>
                <button type="button" tabIndex={parseInt("0")} class="SecondaryAction">
                    Learn more
                </button>
            </div>
        </div>
