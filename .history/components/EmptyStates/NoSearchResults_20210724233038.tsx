import React, { useState, useEffect, Component, Fragment, FC } from 'react';
...
const NoSearchResults:React.FC<EmptyStateProps> = (props) => {
    ...
    return (
        <div className="EmptyState">
            <Flex css={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'stretch', height: '100%', width: '100%' }}>
