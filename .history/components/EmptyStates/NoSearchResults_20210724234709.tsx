...
import { crimson, blackA, mauve } from '@radix-ui/colors'
...
const NoSearchResults:React.FC<EmptyStateProps> = (props) => {
    const { name, cause, icon, action } = props;
        ...
        <div className="EmptyState">
            <Flex css={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%' }}>
                ...
                <Flex css={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%' }}>
                    ...
                    <Box css={{ flexBasis: '0', flexGrow: 1, marginTop: '10px', backgroundColor: 'gainsboro', padding: '10px', borderRadius: '3px' }}>
                        <Text size='1' css={{ fontWeight: '200', width: '325px' }}>
                            Add some more slugs to your collection to start seeing red hot search results
                        </Text>
                    </Box>
                </Flex>
