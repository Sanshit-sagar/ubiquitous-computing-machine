...
function Breadcrumbs() {
    ...
    const pages = [
        { name: session && !loading ? session.user.email : '...', href: '/profile', current: false },
        { name: state.router.history[-1], href: mapHistoryToHref[`${state.router.history[-1]}`], current: true },
    ]; 
