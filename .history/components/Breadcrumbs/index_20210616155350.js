...
function Breadcrumbs() {
    ...
    return (
        ...
        <nav aria-label="breadcrumb" className="breadcrumb flex-row justify-items-start align-center"> 
          <HomeIcon className="flex-shrink-0 h-5 w-5" aria-hidden="true" />
          <a href='/'> Home </a> 
          
          <ol className="breadcrumb flex-row justify-items-start align-center">
