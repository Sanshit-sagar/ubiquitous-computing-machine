                ...
                return (
                      <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                        <span 
                            className={
                                cellsLoading ? 
                                "bp3-skeleton text-xs font-extralight text-black"  : 
                                "text-xs font-extralight text-black"
                            }
                        > 
                            {ellipses(value.slug, 30)} 
                        </span>
                        <span style={{ display: 'flex', flexDirection:'row', justifyContent: 'flex-end', alignItems: 'flex-end' }}>
                            <Button 
                                ...
                                minimal={true} 
                                intent="primary"
                                onClick={() => router.push(`https://writer.hashably.workers.dev/${value.slug}`)} 
                            />
                            <Button 
                                icon="clipboard" 
                                minimal={true} 
            ...
            Cell: ({ value }) => {
                return (
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                        ...
                        <span style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                            <Button 
                                icon="document-open" 
                                minimal={true} 
                                intent="primary"
                                onClick={() => router.push(`https://writer.hashably.workers.dev/${value}`)} 
                            />
                            <Button 
                                icon="clipboard" 
                                minimal={true} 
