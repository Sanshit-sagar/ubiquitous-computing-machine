...
const StatisticTable = ({ columns, data, fetchData, loading, pageCount: controlledPageCount, datasetId, setDatasetId }) => {
    ...
    <Box css={{ border: 'thin solid transparent', bc: 'white' }}>
        ...
        <ScrollArea css={{ height: '500px', width: '1275px' }}>
            <ScrollAreaViewport>
                <Box css={{ bc: darkTheme.colors.loContrast, color: darkTheme.colors.hiContrast, width: '97.5%', mt: '$1', mb: '$2', py: '$2', px: '$1' }}>
