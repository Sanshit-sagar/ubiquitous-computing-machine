...
const Click = ({ value, index }) => {
    const fields =  {
        ...
        'city': value.request_headers.city,
        'country': value.request_headers.country,
        'postalCode': value.request_headers.postalCode,
        'metroCode': value.request_headers.metroCode,
        'longitude': value.request_headers.longitude,
        'latitude': value.request_headers.latitude, 
        'region': value.request_headers.region,
        'ip': value.request_headers.ip,
        'system': value.request_headers.system,
