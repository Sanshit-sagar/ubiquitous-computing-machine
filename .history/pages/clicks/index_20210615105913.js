                                    ...
                                    <div className="flex-1 space-y-1">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-sm font-medium"> 
                                                {value.slug.substring(8)}  
                                            </h3>
                                            <p className="text-sm text-gray-500"> 
                                                {value.request_headers.city}, 
                                                {value.request_headers.postalCode}, 
                                                {value.request_headers.country} 
                                            </p>
                                            <p className="text-sm text-gray-500"> 
                                                {value.request_headers.ip} 
                                            </p>
                                            <p className="text-sm text-gray-500">
                                                {DateTime.fromMillis(parseInt(value.timestamp)).toLocaleString(DateTime.DATETIME_FULL_WITH_SECONDS)}
                                            </p>
                                        </div>
                                        <div>
