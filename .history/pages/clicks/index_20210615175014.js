...
const Click = ({ value, index }) => {
    ...
    const fields =  {   
        ...
        'slug': {
            ...
            secondaryText: value.destination.substring(0, 40) + "...",
            icon: <ExternalLinkIcon  className="h-5 w-5 text-blue-500" /> 
        },
        'ip': {
            primaryText: value.request_headers.ip ? value.request_headers.ip.substring(0, 15) + "..." : null,
            secondaryText: value.request_headers.forwardedFor,
        },
        'geodata': {
