...
const Click = ({ value, index }) => {
    ...
    const fields =  {   
        ...
        'ip': {
            primaryText: value.request_headers.forwardedFor ? value.request_headers.forwardedFor.substring(0, 10) + "..." : null,
            secondaryText: value.request_headers.ip,
        },
        'geodata': {
                            ...
                            <div className="ml-4">
                                ...
                                <div className="text-sm text-gray-500">
                                    <Link href={val[1].secondaryText || ' '}>
                                        {val[1].secondaryText ? val[1].secondaryText.substring(0, 40) + "..." : ' '}
                                    </Link>
                                </div>
                            </div>
