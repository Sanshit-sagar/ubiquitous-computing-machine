...
const StatTables = () => {
    ...
    let datasets = [
        ...
        { id: 3, data: summary.engines, title: 'Engines', size: 'md'},
        { id: 4, data: summary.users, title: 'Users', size: 'md' },
        { id: 5, data: summary.operatingSystems, title: 'Op. Systems', size: 'md' },
    ]
            ...
            <Flex css={{ width: '100%', fd: 'column', jc: 'space-between', ai: 'stretch', gap: '$2' }}>                
                ...
                <Box css={{ padding: '$1', height: '450px', overflowY: 'scroll' }}>
                    <Flex css={{ fd:'row', jc:'space-between', ai: 'stretch', mt: '$1' }}>  
                        <DataTableWrapper dataset={clickstream} title={'Recent Views'} />
                        <DataTableWrapper dataset={mostViewed} title={'Most Views'} /> 
                        <DataTableWrapper dataset={ips} title={'IP Addresses'} /> 
                    </Flex>
                </Box>
            </Flex>
        </Card>
