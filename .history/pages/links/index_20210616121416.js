            ...
            <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div className="shadow overflow-scroll border-b border-gray-200 sm:rounded-lg">
                    ...
                    <div class="container mx-auto py-6 px-4">
                        <h1 class="text-3xl py-2 border-b mb-4">
                            {title}
                        </h1>
                                    ...
                                    {columns.map(function(value, index) {
                                        return (
                                            <th 
                                                key={index} 
                                                scope="col"
                                                class="bg-gray-100 sticky top-0 border-b border-gray-200 px-6 py-2 px-3-sticky text-gray-600 font-bold tracking-wider uppercase text-xs"
                                            >
                                                {value.Header}
                                            </th>
                                        )
