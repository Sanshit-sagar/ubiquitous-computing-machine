                ...
                {Object.entries(fields).map(function(val, ind) {
                    return (
                        <>
                            ...
                            <td>
                                <span className={`px-2 py-3 inline-flex text-md leading-5 font-semibold rounded-md ${status==='active' ?  'bg-green-100 text-green-800' : 'bg-red-400 text-gray-200'}`}>
                                    {getStatus(fields.slug, fields.expiry)}
                                </span>
                            </td>
                        </>
                    )
