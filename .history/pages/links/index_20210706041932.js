...
const LinkEntry = ({ index, cellsInRow, toggle }) => {
    ...
    const cellValues = [
        ...
        [useDateTimeConverter(parseInt(cells.timestamp)).primaryText, useDateTimeConverter(parseInt(cells.timestamp)).secondaryText],
        [cells.ttl ? formatDate(new Date(parseInt(cells.ttl))) : '', '']
    ];
