...
const TabulatedLinks = ({ uid }) => {
    if(!uid) return <p> Login to save and edit a collection </p>
    ...
    if(!links.length) return <p> Nothing to show you, add a new one <a href='/new'> here </a></p>
...
export default function Links({ user }) {
    ...
    return (
        <StackedLayout 
            ...
            children={<TabulatedLinks uid={uid} />} 
        />
    );
}
