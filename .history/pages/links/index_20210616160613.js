    ...
    return (
        ...
        { links && !loading && !error ? 
            <div className="overflow-x-auto bg-white rounded-lg shadow overflow-y-scroll relative">
                ...
                <div class="sm:flex-1 sm:flex sm:items-center sm:justify-between mx-3 my-2 work-sans bg-indigo-700 text-gray-50">
                    <div>
                        <p class="text-sm leading-5 text-blue-700">
                            ...
                            of
                            <span class="font-medium">{Object.entries(links).length}</span>
                            results
                        </p>
                    </div>
                    <div>
