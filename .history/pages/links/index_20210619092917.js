...
const LinkEntry = ({ link, user }) => {
    ...
    return (
        <>
            ...
            {/* <div className="w-full h-full flex bg-indigo-300 text-black rounded-md border-md ring-50 hover:bg-indigo-600 px-1 py-1 mx-0 my-0"> */}
...
const TabulatedLinks = ({ uid, user }) => {
    ...
    return (
        <div className="container overflow-visible">
            <table className="border-collapse table-auto w-80 h-80 whitespace-no-wrap table-striped relative">
                <thead>
                        ...
                        {columns.map(function(value, index) {
                            return (
                                <th 
                                    key={index} 
                                    scope="col"
                                    class="bg-black text-white bg-gray-100 sticky top-0 border-b border-gray-200 px-6 py-2 text-gray-600 font-bold tracking-wider uppercase text-xs"
                                >
                                    {value.Header}
                                </th>
                            )
