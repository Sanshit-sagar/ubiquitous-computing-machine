...
function reducer(state, action) {
  switch(action.type) {
    ...
    case 'increment': 
      const prev = state.actionStats.highestAchieved
      const isGoePrevHighest = action.payload.value ? (action.payload.value > prev) : false; 
      return {
        ...state,
        ...
        actionStats: {
            ...
            highestAchieved: isGoePrevHighest ? prev + 1 : prev,
