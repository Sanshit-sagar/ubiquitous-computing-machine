...
const InputVerificationIcon = () => {

  return (
    <div>
     {inputValueIsValid ?  <CheckCircledIcon /> :  <CrossCircledIcon />}
    </div>
  )
}
...
const SignIn = ({ metadata, providers, csrfToken }) => {
...
const metadata = {
    ...
    description: 'Google, GitHub, Facebook, Email Link, what more can you want?'
}
