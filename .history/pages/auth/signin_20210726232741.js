...
const SignIn = ({ providers, csrfToken }) => {
    ...
    return (
      <StackedLayout pageMeta={metadata}>
        <Box css={{  width: '250px', padding: '5px', border: 'thin solid black', borderRadius: '5px', backgroundColor: 'white'}}>
          ...
          <Box css={{ marginTop: '25px', marginBottom: '20px' }}>
            <StyledSeparator />
          </Box>

          <Box css={{ width: '100%', fd: 'row', jc: 'flex-start', ai: 'center' }}>
            <Text> Or, Sign in with one of these accounts  </Text>
          </Box>
