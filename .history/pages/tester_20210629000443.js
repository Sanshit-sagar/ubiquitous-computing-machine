...
function reducer(state, action) {
  switch(action.type) {
    ...
    case 'increment': 
      const isGoePrevHighest = action.payload.value ? (action.payload.value > state.actionStats.highestAchieved) : false; 
      return {
        ...state,
        ...
        actionStats: {
            ...
            highestAchieved: isGoePrevHighest ? state.actionStats.highestAchieved + 1 : state.actionStats.highestAchieved,
