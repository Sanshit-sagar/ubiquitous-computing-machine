...
export default async function handler(req, res) {
    ...
    try {
        ...
        const clickstream = rawClickstream.sort((a, b) => {
            ...
            } else if(arrA.misc.finalTimestamp && arrB.misc.finalTimestamp) {
                return arrA.misc.finalTimestamp - arrB.misc.finalTimestamp
            } else if(arrA.timestamp || arrA.misc.finalTimestamp) {
                return arrA.misc.finalTimestamp 
            } 
            return arrB.misc.finalTimestamp
        })

        var max = Number.MIN_SAFE_INTEGER
        let minTime = clickstream[0].timestamp || clickstream[0].misc.finalTimestamp
        let maxTime = 0
