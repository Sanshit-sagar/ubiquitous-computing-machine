...
import SlugProfileDialog from '../../components/SlugProfile'
...
const StyledCell = ({ value, long, short, xshort }) => {
    return (
        <Box css={{ width: long ? '150px' : short ? '50px' : xshort ? '30px' : '100px', height: '30px', overflowY: 'hidden', overflowX: 'hidden' }}>
...
const getColumns = () => {
    ...
    const columns = useMemo(() => [
        ...
        { 
            ...
            accessor: 'slug', 
            Cell: ({ value }) => <StyledCell name={value} />,
        },
        { 
        ...
        // },
        { 
            Header: <StyledHeader name={'User Agent'} />, 
            accessor: 'system',
            Cell: ({ value }) => <StyledCell value={value} long={true} /> 
        },
        { 
        ...
        {
            Header: <StyledHeader name={'Client TCP RTT'} />,
