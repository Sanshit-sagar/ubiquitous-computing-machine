...
const DataTableWrapper = ({ dataset, title, loading }) => {
    ...
    return (
        <Box css={{ border: 'thin solid white', br: '$1', margin: '$1' }}>
            <Flex css={{  fd: 'column', jc: 'flex-start', ai: 'center', gap: '$1' }}>
                ...
                <Box css={{ width: '100%', padding: '$2', height: '250px', width: '350px' }}> 
...
const StatTables = () => {
    ...
    return (
        <Card interactive={true} ghost active={true} css={{ height: '100%', width: '100%', height: '520px', bc: mauve.mauve11 }}>
