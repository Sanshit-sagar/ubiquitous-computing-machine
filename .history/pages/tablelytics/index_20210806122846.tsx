...
const TablulatedData = ({ clickstream }) => {
    ...
    const page = localData.slice(0,10);
...
const GraphicalTable = ({ clicks }) => {
    let data = generateTableDataAndColumn(clicks);

    const columns = useMemo(() => [
        { Header: '#', accessor: 'id', width: '100px' }, 
        { Header: 'Slug', accessor: 'name', width: '100px' },
        { Header: 'Destination URL', accessor: 'destination', width: '100px' },
        { Header: 'Country', accessor: 'country', width: '100px' },
        { Header: 'Location', accessor: 'location', width: '100px' },
        { Header: 'Geodata', accessor: 'geodata', width: '100px' },
        { Header: 'IP Address', accessor: 'ipAddress', width: '100px' },
        { Header: 'Host', accessor: 'host', width: '100px' },
        { Header: 'TLS Version', accessor: 'tlsVersion', width: '100px' },
        { Header: 'HTTP Protocol', accessor: 'httpProtocol', width: '100px' },
        { Header: 'Timestamp', accessor: 'timestamp', width: '100px' },
        { Header: 'ASN', accessor: 'asn', width: '100px' }
    ], []);
