...
const GraphicalTable = ({ clicks }) => {
    ...
    let columns = [
        ...
        { index: 5, title: 'Coordinates', field: 'geodata', hozAlign: 'left', width: 150 },
        { index: 6, title: 'User Agent', field: 'geodata',hozAlign: 'left'  },
        { index: 7, title: 'HTTP Protocol', field: 'ipAddress', hozAlign: 'left' },
        { index: 8, title: 'IP Address', field: 'host', hozAlign: 'left' , width: 120 },
        { index: 9, title: 'Host', field: 'tlsVersion', hozAlign: 'left'  },
        { index: 10, title: 'TLS Version', field: 'httpProtocol',hozAlign: 'left'  },
        { index: 11, title: 'Timestamp', field: 'timestamp', hozAlign: 'left' },
        { index: 12, title: 'ASN', field: 'asn',  hozAlign: 'left' },
        { index: 13, title: 'Views', field: 'views' },
    ];
