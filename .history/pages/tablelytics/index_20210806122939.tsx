...
const GraphicalTable = ({ clicks }) => {
    ...
    const columns = useMemo(() => [
        ...
        { Header: 'Slug', accessor: 'name', width: 100 },
        { Header: 'Destination URL', accessor: 'destination', width: 100 },
        { Header: 'Country', accessor: 'country', width: 100 },
        { Header: 'Location', accessor: 'location', width: 100 },
        { Header: 'Geodata', accessor: 'geodata', width: 100 },
        { Header: 'IP Address', accessor: 'ipAddress', width: 100 },
        { Header: 'Host', accessor: 'host', width: 100 },
        { Header: 'TLS Version', accessor: 'tlsVersion', width: 100 },
        { Header: 'HTTP Protocol', accessor: 'httpProtocol', width: 100 },
        { Header: 'Timestamp', accessor: 'timestamp', width: 100 },
        { Header: 'ASN', accessor: 'asn', width: 100 }
    ], []);
