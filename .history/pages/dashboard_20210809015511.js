    ...
    return (
        <Box css={{ border: 'thin solid silver', br: '$1', margin: '$1' }}>
            <Flex css={{  fd: 'column', jc: 'flex-start', ai: 'center', gap: '$1' }}>
                <Box css={{ width: '100%', padding: '$2', height: '250px', width: '425px' }}> 
...
const StatTables = () => {
    ...
    return (
        <Box css={{ height: '100%', width: '100%', height: '520px', overflowY: 'scroll', overflowX: 'hidden' }}>
            <Flex css={{ width: '100%', fd: 'row', jc: 'space-between', ai: 'stretch', flexWrap: 'wrap', gap: '$2' }}>                
