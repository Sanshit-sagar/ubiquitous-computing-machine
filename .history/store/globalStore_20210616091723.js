        ...
        case 'navigate':
            return {
                ...
                router: {
                    ...
                    breadcrumbs: action.payload.direction === 'forward' ? [...state.breadcrumbs, action.payload.route] : [...state.breadcrumbs.splice(state.breadcrumbs.length - 2), action.payload.route],
                }
            };
        default:
            return state
