    ...
    switch(action.type) {
        case 'update_datasets':
            return {
                ...
                datasetStart: action.payload.datasetStart,
                datasetEnd: action.payload.datasetEnd,
        ...
        case 'select': 
            alert(`Recieved: ${JSON.stringify(action.payload)}`)
            return {
                ...state, 
                selectedTabId: action.payload.value,
                lastUpdatedAt: new Date().getTime().toString(),
            }; 
        default: 
            return state;
