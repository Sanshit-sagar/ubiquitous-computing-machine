...
export const TableScrollView = ({ content }) => {
  ...
  return (
    <Box css={{ borderRadius: '5px', backgroundColor: '#efefef' }}>
      <ScrollArea style={{ width: '1275px', height: '580px' }}>
        <ScrollAreaViewport css={{ backgroundColor: 'white' }}>
      
      <Box css={{ width: '100%', mt: '$1', mb: '$2', py: '$2', px: '$1', backgroundColor: darkTheme.color.loContrast, color: darkTheme.colors.hiContrast }}>
        {content}
      </Box>
        </ScrollAreaViewport>
