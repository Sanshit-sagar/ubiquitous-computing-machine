    ...
    return (
        <Box css={{ ml: '$1' }}>
            <Flex css={{ width: '100%', fd: 'row', jc: 'space-between', ai: 'stretch' }}>
                <Box css={{ mt: '$1', mr: '$1' }}> {icon} </Box> 
                <Text css={{ mt: '$1' }}> {text} </Text>
            </Flex>
        </Box>
    )
}
...
const BreadcrumbsHeader = () => {
    ...
    const crumbs = [
        { id: '1', href: '/', icon: <HomeIcon />, text: 'page1' },
        { id: '2', href: '/', icon: <FileIcon />, text: 'page2' },
        { id: '3', href: '/', icon: <CheckboxIcon />, text: 'page3' }
    ];
