...
export const TableScrollView = ({ content }) => {
  ...
  return (
    <Box css={{ borderRadius: '5px', backgroundColor: '#efefef' }}>
      <ScrollArea style={{ width: '1250px', height: '500px' }}>
        <ScrollAreaViewport css={{ backgroundColor: 'white' }}>
      
      <Box css={{ width: '97.5%', mt: '$1', mb: '$2', py: '$2', px: '$1', backgroundColor: darkTheme.colors.loContrast, color: darkTheme.colors.hiContrast }}>
        {content}
      </Box>
        </ScrollAreaViewport>
