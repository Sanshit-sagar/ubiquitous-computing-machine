...
export const SelectCheckboxItem = styled(DropdownMenuPrimitive.CheckboxItem, { ...itemStyles });
export const SelectRadioItem = styled(DropdownMenuPrimitive.RadioItem, { ...itemStyles });