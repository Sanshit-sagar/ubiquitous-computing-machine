...
const CustomToolbar = () => {
    ...
    const handleClick = (e: React.HTMLMouseEvent) => {
        toast.success(`Clicked toolbar button`);
    }
    
    return (
        <Box 
            css={{ 
                py: '$1', px: '$2', height: '50px', bc: '#fff', 
                color: '#000', border: 'thin solid transparent', br: '5px',
                borderBottomColor: '#efefe1', borderBottomRadius: '0px'
            }}
        >
