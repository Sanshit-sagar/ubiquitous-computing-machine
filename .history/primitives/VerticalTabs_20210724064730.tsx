...
const StyledTrigger = styled(Tabs.Trigger, {
    ...
    '&:first-child': { 
        ...
        borderTopColor: blackA.blackA10, 
    },
    '&:last-child': { 
    ...
    '&focus': { outline: 'none', boxShadow: `0 0 0 1px ${blackA.blackA5}` },
    '&:hover': { backgroundColor: blackA.blackA3, color: blackA.blackA11 },
}); 
...
const VerticalTabs = ({ tabItems }) => {
    ...
    const handleTabChange = (title) => {
        toast.success(`Updated Active Tab to ${title}`)
        setCurrentTab(title);
    ...
    }, [globalState.currentTab, currentTab, globalState.currentPage])
