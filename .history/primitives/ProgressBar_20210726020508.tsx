...
import { styled, css, keyframes, CSS, StitchesVariants } from '../stiches.config';
...
type ProgressBarOwnProps = Polymorphic.OwnProps<typeof ProgressPrimitive.Root> & ProgressBarCSSProp & ProgressBarVariants;
type ProgressBarComponent = Polymorphic.ForwardRefComponent<Polymorphic.IntrinsicElement<typeof ProgressPrimitive.Root>, ProgressBarOwnProps>;
