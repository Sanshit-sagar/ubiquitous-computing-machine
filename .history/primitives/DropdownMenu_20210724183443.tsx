            ...
            <DropdownMenu.RadioItem value={'string'} as={'flex'}>
              ...
              <Box css={{ width: '100%' }}> 
                { session && session.user ? 
                  <Flex css={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: '10px' }}>
                    <Flex css={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'stretch' }}>
                      <Text>
                        { 
