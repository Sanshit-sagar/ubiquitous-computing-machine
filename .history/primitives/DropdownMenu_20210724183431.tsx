      ...
      <DropdownMenu.Root>
        ...
        <StyledContent sideOffset={5} align="end">
          ...
          <StyledItem onSelect={() => console.log(`Clicked on the profile item`)}>
            <DropdownMenu.RadioItem value={'string'} as={'flex'}>
              ...
              <Box css={{ width: '100%' }}> 
                { session && session.user ? 
                  <Flex css={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: '2px' }}>
                    <Flex css={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'stretch', gap: '10px' }}>
                      <Text>
                        { 
