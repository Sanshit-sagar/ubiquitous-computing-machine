...
const CustomBreadcrumbs = () => {
    ...
    return (
        <Flex css={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', paddingRight: '2px' }}>
            ...
            <Flex css={{ fd: 'row', jc: 'flex-start', ai: 'stretch', gap: '15px' }}>
            ...
            <ActiveLink css={{ fontSize: '14px', marginRight: '10px' }}>
                {   
                        state.currentPage.charAt(0) === '/' 
                    ?  `${state.currentPage.charAt(1).toUpperCase()}${state.currentPage.substring(2)}` 
                    :  `${state.currentPage.charAt(0).toUpperCase()}${state.currentPage.substring(1)}` 
                    ?  `${state.currentPage?.length}`  : 'N/A' 
                }
            </ActiveLink>

            <ActiveLink css={{ fontSize: '14px', marginLeft: '10px' }}>
    ...
    <StyledToolbar>
        ...
        <Box css={{ width: '60%', height: '25px' }}>
            <Flex css={{ display: 'flex', flexDirection: 'row', justifyContent:'flex-end', alignItems: 'stretch'}}>
                ...
                <ActiveLink style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', alignItems:'center', flexWrap: 'nowrap'}}>
