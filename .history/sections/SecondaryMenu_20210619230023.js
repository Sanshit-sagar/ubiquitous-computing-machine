    ...
    return (
        ...
        <div className="h-screen flex overflow-hidden bg-black border-l-2 border-gray-700">
            ...
            {/* <div className="hidden lg:flex lg:flex-shrink-0"> */}
              ...
              <nav
                aria-label="Sections"
                className="hidden flex-shrink-0 w-96 bg-white text-black border-r border-blue-gray-200 xl:flex xl:flex-col"
              >
                ...
                <div className="flex-1 min-h-0 overflow-y-auto">
                                    {navigation.map((item) => (
                                        <a
                                            key={item.name}
                                            href={item.href}
                                            className="text-gray-900 hover:bg-blue-500 hover:text-gray-200 group flex items-center mx-2 px-2 py-2 text-sm font-medium rounded-md"
                                        >
                                        <item.icon
