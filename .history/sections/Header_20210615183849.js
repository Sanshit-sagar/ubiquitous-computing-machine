...
const Header = () => {
    ...
    const navigation = [
        { id: 'new', name: 'New Slug', current: currentPage==='new' },
        { id: 'dashboard', name: 'Dashboard', current: currentPage==='dashboard' },
        { id: 'clicks', name: 'Click Stream',  current: currentPage==='clicks'},
        { id: 'links', name: 'Saved Links', current: currentPage==='links' },
    ];

    const handleNavigationOption = (id) => {
        setCurrentPage(id);
    }
                            ...
                            <div className="flex space-x-4">
                                {navigation.map((item) => (
                                    <a
                                        ...
                                        // href={item.href}
                                        as="button"
                                        onClick={() => handleNavigationOption(item.id)}
