        ...
        return (
            <div>
                <div className="relative" ref={menuRef}>
                    <button 
                        className="bg-red-500 hover:bg-red-700 inline-flex justify-between align-center py-2 px-2 my-2 mx-2 w-full border-solid border-1 border-light-blue-500 rounded-xl ring-blue-300"
