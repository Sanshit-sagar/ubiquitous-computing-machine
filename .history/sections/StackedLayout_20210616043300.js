           ...
           <div className="bg-white shadow-sm">
                ...
                <div>
                    ...
                    <div className="relative text-gray-900 focus-within:text-gray-600">
                        ...
                        <input
                            id="search"
                            className="block w-full bg-white bg-opacity-20 py-2 pl-10 pr-3 border border-gray-900 rounded-md leading-5 text-gray-900 placeholder-white focus:outline-none focus:bg-opacity-100 focus:border-transparent focus:placeholder-gray-500 focus:ring-0 sm:text-sm"
                            placeholder="Search"
                            type="search"
                            name="search"
                        />
