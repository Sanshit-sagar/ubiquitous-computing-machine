...
function StackedLayout({ children, pageMeta }) {
    ...
    return (
        <div className="h-screen bg-gray-50 flex overflow-x-auto overflow-y-scroll">
           ...
           <div className="w-full h-full overflow-x-auto overflow-y-scroll px-1 py-1 my-1 mx-1 flex-col justify-start align-stretch">
                <header className="w-full">
                    <div className="w-full rounded-md py-3 px-1 mx-1 my-2 flex justify-start align-stretch overflow-auto bg-gray-900 text-gray-50 dark:bg-gray-50 dark:text-gray-900">
                            ...
                            <div className="flex-1 flex">
                                ...
                                <div className="relative w-full text-gray-50 focus-within:text-gray-200">
                                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center">
                                        <SearchIcon 
                                            className="flex-shrink-0 h-5 w-5 pl-1 pr-6 text-indigo-900" 
                                            aria-hidden="true" 
                                        />
                                    </div>
                                    <input
                                        name="search_field"
                                        id="search_field"
                                        className="h-full w-full border-red rounded-md py-2 pl-2 pr-3 text-base text-gray-900 placeholder-indigo-900 focus:outline-none focus:ring-50 focus:border-red-500 focus:placeholder-indigo-900"
                                        placeholder="Search"
                                        type="search"
                                    />
                                </div>
            ...
            <div className="lg:flex lg:items-center lg:justify-between">
                <main className="w-full flex-1 overflow-y-scroll overflow-x-auto">
                    <section
                        aria-labelledby="primary-heading"
                        className="min-w-0 flex-1 h-full flex flex-col overflow-hidden lg:order-last dark:bg-black light:bg-white px-1 py-1"
                    >
                        {children}
                    </section>
                </main>
