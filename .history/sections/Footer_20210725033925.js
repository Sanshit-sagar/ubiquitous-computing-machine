...
const footerLinks = [
    { id: 'license', title: 'MIT License', href: `${TODO}`, icon: TodoIcon, variant: 'subtle' },
    { id: 'changelog', title: 'Changelog', href: `${TODO}`, icon: TodoIcon, variant: 'subtle' },
    { id: 'feedback', title: 'Feedback', href: `${TODO}`, icon: EnvelopeClosedIcon, variant: 'subtle' },
    { id: 'subscribe', title: 'Subscribe', href: `${TODO}`, icon: FeedIcon, variant: 'subtle' },
