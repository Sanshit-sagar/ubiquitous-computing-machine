...
const sidebarNavigation = [
  ...
  { name: 'Click Stream', href: '#', icon: CursorClickIcon, current: false },
  { name: 'Saved Links', href: '#', icon: CollectionIcon, current: true },
//   { name: 'Archive', href: '#', icon: UserGroupIcon, current: false },
