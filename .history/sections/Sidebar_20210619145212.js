...
const Sidebar = ({ }) => {
    ...
    // };
    const sidebarNavigation = [
        { name: 'Open', href: '#', icon: PlusIcon, current: true },
        { name: 'Archive', href: '#', icon: PlusIcon, current: false },
        { name: 'Customers', href: '#', icon: PlusIcon, current: false },
        { name: 'Flagged', href: '#', icon: PlusIcon, current: false },
        { name: 'Spam', href: '#', icon: PlusIcon, current: false },
        { name: 'Drafts', href: '#', icon: PlusIcon, current: false },
    ];
