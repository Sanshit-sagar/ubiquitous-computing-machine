...
const SearchBar = () => {
    ...
    return (
        // <div className="w-full py-6 px-6 bg-indigo-600">
           <div className="w-full bg-white shadow-sm inline-flex flex-row justify-between align-stretch">
            ...
            <div className="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
                <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                    <section aria-labelledby="section-1-title">
                        <h2 id="section-1-title" className="">
                            Section title
                        </h2>
