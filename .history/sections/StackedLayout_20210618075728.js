                    ...
                    {Object.entries(extraButtons).map(function(value, index, array) {
                            ...
                            return (
                                <div key={index} className="bg-gray-900 focus:bg-gray-600">
                                    <button 
                                        className="flex px-1 py-2  my-1 rounded-b-lg ring-gray-300 focus:ring-gray-50 focus:ring-offset-2"
                                        onClick={() => {
                                            value[1].href.length ? 
                                                ...
                                                <Menu.Item key={item.name}>
                                                    {({ active }) => (
                                                        <a
                                                            href={item.href}
                                                            className={classNames(
                                                                active ? 'bg-gray-100' : 'block px-4 py-2 text-sm hover:text-gray-200'
                                                            )}
                                                        >
                                                            {item.name}
                                                        </a>
