...
const NestedLayout = ({ children }) => {
    ...
    return (
        <Card css={{ width: '100%', height: '650px', width: '1300px', mx: '$3', bc: blackA.blackA12, border: 'thin solid silver' }}>
            <Flex css={{  fd: 'column', jc: 'flex-start', ai:'stretch', gap: '$3' }}>
                ...
                <Box css={{ minHeight: '600px', border: 'thin solid silver', br: '$2',  fd: 'row', jc: 'stretch', ai: 'stretch' }}>
                    {children}
                </Box>
