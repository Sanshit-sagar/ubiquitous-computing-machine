...
const Sidebar = ({ handleNavigation }) => {
    ...
    const sidebarNavigation = [
        ...
        { name: 'Clicks', href: '/dashboard', icon: CursorClickIcon, current: isCurrentPage('dashboard') },
        { name: 'Saved', href: '/links', icon: CollectionIcon, current: isCurrentPage('links') },
        { name: 'Dashboard', href: '/dashboard2', icon: ChartSquareBarIcon, current: isCurrentPage('dashboard') },
        { name: 'Leaderboard', href: '/leaderboards2', icon: PresentationChartLineIcon, current: isCurrentPage('leaderboard') },
    ];
