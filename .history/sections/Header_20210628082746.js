...
//     const [session, loading] = useSession()
//     return (
//         <>{session && session.user?.email ? <span className='p-2 m-2 text-red-400 text-md font-extralight'>You are not signed in</span> :
//         <> <span className='p-2 m-2 text-green-700 text-md font-extralight'>
//                 <small>Signed in as</small><br/>
//                 <strong>{session.user.email || session.user.name}</strong>
//             </span>
//         </>  : session.user.image ? <span className='bg-white h-6 w-6'/> : null}
//          </>
//     );
// }
