...
function StackedLayout({ children, pageMeta }) {
    ...
    <div className="h-screen bg-gray-900 flex">
        ...
        <div className="w-full h-full flex-col justify-end align-stretch border-b-4">
            ...
            <main className="flex-col justify-between align-center">
                <section className="w-full bg-black ring-2 ring-gray-50 shadow">
                    
                    <div className="w-full px-2 rounded-md bg-black text-white inline-flex justify-between items-start">
                        <Breadcrumbs /> 
                    </div>

                    <div aria-labelledby="primary-heading" className="w-full flex-row items-start justify-between">
                        <h3 className="text-2-lg leading-6 font-lightest text-white">
                ...
                <div className="container overflow-hidden overscroll-contain max-h-80 rounded-md bg-gray-900 shadow-lg">
                    {children}
                </div>
            </main>
