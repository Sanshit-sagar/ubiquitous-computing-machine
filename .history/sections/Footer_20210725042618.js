...
const FooterLinkIconPair = ({ footerLinkComp, icon, drink }) => {
...
const footerLinks = [
    ...
    { id: 'github', title: 'GitHub (Source)', icon: GitHubLogoIcon, variant: 'subtle', href: `https://www.github.com/sanshit-sagar/ubiquitous-computing-machine`, description: 'A chonker of an app' },
];
