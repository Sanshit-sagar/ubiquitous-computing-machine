           ...
           <div className="w-full h-full overflow-x-auto overflow-y-scroll px-1 mx-1 flex-col justify-start align-stretch">
                ...
                <div className="w-full rounded-lg mt-3 bg-indigo-900 overflow-hidden shadow">
                    <main className="bg-white-50">
                        ...
                        >
                            <div className="w-full px-1 py-1 rounded-md border-gray-50 bg-gray-50 text-gray-900 inline-flex flex-row justify-between items-start">
                                <div className="w-full pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
                                    <Breadcrumbs /> 
