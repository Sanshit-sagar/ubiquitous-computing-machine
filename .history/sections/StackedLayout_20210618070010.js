...
function StackedLayout({ children, pageMeta }) {
    ...
    return (
        <div className="h-screen w-full bg-gray-900 flex overflow-hidden">
            <div className="w-full bg-gray-900 border-gray-50 overflow-hidden md:block">
                <div className="w-full py-6 flex flex-col items-center">
                    <div className="flex-shrink-0 flex items-center">
                        <Logo />
                    </div>
                    
                    <div className="flex-col mt-6 w-full px-1 space-y-1 bg-gray-900 text-white border-gray-50">
