    ...
    return (
        <div className="h-screen bg-gray-50 flex overflow-x-auto overflow-y-scroll">
           ...
           <div className="w-full h-full overflow-x-auto overflow-y-scroll px-1 mx-1 flex-col justify-start align-stretch">
                ...
                <div className="w-full rounded-lg mt-3 bg-indigo-900 overflow-hidden shadow">
                    <main className="bg-white-50">
                        <section
                            aria-labelledby="primary-heading"
                            className="w-full flex-row items-start justify-between"
                        >
                            <div className="px-1 py-1 rounded-md border-gray-50 bg-gray-900 text-gray-50  w-full inline-flex flex-row justify-between items-start">
                                <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                                    {/* <p className="text-sm font-medium text-pink-500">{state && state.router ? state.router.current : ''}</p> */}
                                    <Breadcrumbs /> 
                                    <p className="text-xl font-bold text-gray-50 sm:text-2xl">{session ? session.user.name : <CustomSpinner />}</p>
                                    <p className="text-sm font-medium text-gray-200">{session ? session.user.role  : <CustomSpinner />}</p>
                                </div>
                                <StatisticsCards />
                            </div>
                        </section>

                        <div className="bg-gray-50 dark:bg-indigo-900 shadow rounded-md">
                            {children}
                        </div>
                    </main>
                </div>
