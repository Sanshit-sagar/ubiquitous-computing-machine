...
const SecondarySidebar = ({ handleNavigation }) => {
    ...
    return (
        <div className="h-screen flex overflow-hidden border-l-2 border-gray-700">
            <div className="flex xl:overflow-hidden">
                ...
                <nav
                    aria-label="Sections"
                    className='bg-light-blue-900 relative z-10 border-b border-teal-500 border-opacity-25 lg:bg-transparent lg:border-none'
                >
