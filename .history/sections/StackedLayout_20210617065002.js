                            ...
                            <div className="flex-1 flex">
                                ...
                                <div className="relative w-full text-gray-50 focus-within:text-gray-200">
                                    ...
                                    <input
                                        name="search_field"
                                        id="search_field"
                                        className="h-full w-full border-red py-2 pl-2 pr-3 text-base text-gray-900 placeholder-indigo-900 focus:outline-none focus:ring-50 focus:border-red-500 focus:placeholder-indigo-900"
                                        placeholder="Search"
                                        type="search"
                                    />
                                </div>
