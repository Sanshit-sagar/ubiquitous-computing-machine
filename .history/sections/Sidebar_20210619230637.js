    ...
    <nav aria-label="Sidebar" className="hidden md:block md:flex-shrink-0 md:bg-black md:overflow-y-auto border-white">
        ...
        <div className="h-full w-15 flex flex-col content-between">
            ...
            <div>
                ...
                <div className="flex-shrink-0 inline-flex items-center justify-center h-10 w-10 rounded-sm m-2 text-white hover:bg-gray-700">
                    <a href="/profile" className="flex-shrink-0">
                        <img className="inline-block h-10 w-10 rounded-sm" src={session.user.image} alt="" />
                    </a>
                </div>}
            </div>
