                    ...
                    <div className="container relative left-0 z-50 flex w-3/4 h-auto">
                        <div className="relative inline-flex items-center w-full lg:w-64 h-full group">
                            ...
                            <input 
                                ...
                                className="inline-flex pl-10 bg-white text-black dark:bg-gray-900 dark:text-white rounded-md focus:border-transparent focus:outline-none focus:ring-2 focus:ring-green-300 ring-opacity-90aa-input" 
                            />
                            <span>
