...
const Sidebar = ({ }) => {
    ...
    <nav aria-label="Sidebar" className="hidden md:block md:flex-shrink-0 md:bg-black md:overflow-y-auto border-white">
        ...
        <div className="relative w-15 flex flex-col p-4 space-y-3">
            <div className="absolute inset-y-0 left-0 md:static md:flex-shrink-0">
                <a
                    href="#"
                    className="flex items-center justify-center h-10 w-10 bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600"
                >
                    <Logo />
                </a>
            </div>
            ...
            {sidebarNavigation.map((item) => (
                ...
                className={classNames(
                    ...
                    'flex-shrink-0 inline-flex items-center justify-center h-10 w-10 rounded-sm'
                )}
                >
