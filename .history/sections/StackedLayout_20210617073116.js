                        ...
                        >
                            <div className="px-1 py-1 rounded-md border-gray-50 bg-gray-900 text-gray-50  w-full inline-flex flex-row justify-between items-start">
                                <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                                    <Breadcrumbs /> 
                                    <p className="text-xl font-light text-gray-50 sm:text-2xl">{session ? session.user.name : <CustomSpinner />}</p>
                                    <p className="text-sm font-light text-gray-200">{session ? session.user.role  : <CustomSpinner />}</p>
                                </div>
