        ...
        return (
            <div>
                <div className="relative" ref={menuRef}>
                    <button 
                        className="bg-red-500 hover:bg-red-700 inline-flex justify-between align-center py-2 px-2 my-2 mx-2 w-full border-solid border-4 border-light-blue-500 rounded-xl ring-blue-300"
    ...
    return (
        <div className="w-full bg-gray-200 inline-flex flex-row justify-between align-stretch">
            ...
            <div>
                ...
                <div className="relative text-gray-900 focus-within:text-gray-600">
                    <div className="pointer-events-none absolute inset-y-0 left-0 pl-3 flex items-center">
                        <SearchIcon className="h-5 w-5" aria-hidden="true" />
                    </div>
                    <input
                        id="search"
                        className="block w-full bg-white bg-opacity-20 py-2 pl-10 pr-3 border border-gray-900 rounded-md leading-5 text-gray-900 placeholder-gray-900 focus:outline-none focus:bg-opacity-100 focus:border-transparent focus:placeholder-gray-500 focus:ring-0 sm:text-sm"
                        placeholder="Search"
                        type="search"
                        name="search"
                    />
