...
function StackedLayout({ children, pageMeta }) {
    ...
    return (
        <div className="h-screen bg-gray-900 flex overflow-x-auto overflow-y-scroll">
           ...
           <div className="w-full h-full px-1 mx-1 flex-col justify-start align-stretch">
                <header className="w-full bg-white shadow inline-flex justify-items-end align-baseline">
