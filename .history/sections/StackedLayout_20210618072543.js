                ...
                >
                    {Object.entries(extraButtons).map(function(value, index, array) {
                        <li key={index}>
                            return (
                                <button 
                                    className="flex px-2 py-2 mx-1 my-1 border-gray-50 bg-gray-50 rounded-md"
                                    onClick={() => {value[1].href.length ? router.push(`${value[1].href}`) : console.log('no destination')}   
                                >
                                    <span className="text-small font-light text-gray-50 text-color-gray-200">
                                         {value[1].title}
                                    </span>
                                </button>
                            )
