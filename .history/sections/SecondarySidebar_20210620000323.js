    ...
    return (
        <div className="h-screen flex overflow-hidden border-l-2 border-gray-700">
            <div className="flex xl:overflow-hidden">
                <nav className="hidden flex-shrink-0 w-96 bg-white text-black border-r border-blue-gray-200 xl:flex xl:flex-col">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto">
                        {navigation.map((item) => (
                            <a
                                ...
                                item.current ? 'bg-gray-900' : 'hover:bg-gray-900 hover:bg-opacity-50',
