    ...
    <div className="mx-auto px-4">
        <div className="bg-gray-900 border-gray-50 overflow-x-scroll overflow-y-scroll md:block">
            <div className="w-full py-6 flex flex-col items-center">
                ...
                <div className="flex-col mt-6 w-full px-3 space-y-1 bg-gray-900 text-white border-t-2">
        ...
        <div className="w-full h-full flex-col justify-end align-stretch border-b-4 border-white">
            ...
            <div className="w-full bg-black overflow-x-auto shadow">
                <main className="w-full bg-white-50">
                    ...
                    <div className="bg-gray-700 shadow max-h-96 overflow-x-scroll mx-1 mb-1 rounded-xs">
                        {children}
                    </div>
                </main>
            </div>
