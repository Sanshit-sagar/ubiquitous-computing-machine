        ...
        <div className="w-full inline-flex flex-row justify-between items-center">
            ...
            <div>
                <div className="sm:flex sm:items-center">
                    ...
                    <button
                        className="w-full inline-flex items-center justify-center rder border-transparent shadow-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
